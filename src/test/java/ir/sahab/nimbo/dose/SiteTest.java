...
public class SiteTest {
    ...
    public void addNewsToDb() {
        RssFeed feed = new RssFeed("ایسنا", "https://www.isna.ir", "جدیدترین اخبار ورزشی، حوادث، سیاسی و اقتصادی ایران و سایر مناطق جهان را در خبرگزاری ایسنا بخوانید", "", "© 2016 isna.ir. All rights reserved", "");
        ...
        Assert.assertTrue(DbHandler.getInstance().getNewsBySite("ISNA", 1).contains(new News(message, site.getAddress())));
    }
